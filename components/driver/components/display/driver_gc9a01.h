...
#ifndef __DRIVER_GC9A01_H__
#define __DRIVER_GC9A01_H__
 ...
 * @fn      gc9a01_init
 *
 * @brief   Initial SPI, GPIO and DMA used by gc9a01, and init gc9a01 registers.
 */
void gc9a01_init(void);

/************************************************************************************
 * @fn      gc9a01_set_window
 *
...
/************************************************************************************
 * @fn      gc9a01_display_wait_transfer_done
 *
 * @brief   Used to wait for all data have been sent to gc9a01 when DMA is used.
 */
 ...
 */
void gc9a01_display_gather(uint32_t pixel_count, uint16_t *data, uint16_t interval, uint16_t count);

/************************************************************************************
 * @fn      gc9a01_dma_isr
 *
 * @brief   DMA isr handler for gc9a01.
 */
void gc9a01_dma_isr(void);
