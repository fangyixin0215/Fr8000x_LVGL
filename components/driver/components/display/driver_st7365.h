...
#ifndef __DRIVER_ST7365_H__
#define __DRIVER_ST7365_H__
 ...
 */
void st7365_display_gather(uint32_t pixel_count, uint16_t *data, uint16_t interval, uint16_t count);
