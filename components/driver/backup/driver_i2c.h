...
typedef struct 
{
    ...
    volatile uint32_t              SS_SCL_HCNT;              /* Offset 0x14 */
    volatile uint32_t              SS_SCL_LCNT;              /* Offset 0x18 */
    volatile uint32_t              FS_SCL_HCNT;              /* Offset 0x1C */
    volatile uint32_t              FS_SCL_LCNT;              /* Offset 0x20 */
    volatile uint32_t              HS_SCL_HCNT;              /* Offest 0x24 */
    volatile uint32_t              HS_SCL_LCNT;              /* Offest 0x28 */
    ...
    volatile uint32_t              HS_SPKLEN;                /* Offest 0xA4 */
...
typedef struct
{
    ...
    uint32_t  SCL_HCNT;               /* This parameter can be a 16-bit value */
    uint32_t  SCL_LCNT;               /* SCL high/low level hold time */
