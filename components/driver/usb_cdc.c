...
void usb_cdc_serialReceive(void)
{
    ...
    while (fr_uart_isRxFifoEmpty(0x50050000) == false)
    {
        TxBuffer[Tx_Total++] = fr_uart_read(0x50050000);
...
{
    uart_write(0x50050000, Buffer, Size);
}
...
{   
    ...
    if (LineCoding.dwDTERate != Temp_LineCoding.dwDTERate) 
    {
        ...
        fr_uart_setBaudrate(0x50050000, LineCoding.dwDTERate / 100);
    }
        ...
        LineCoding.bDataBits   != Temp_LineCoding.bDataBits) 
    {
        ...
        fr_uart_setLineControl(0x50050000, lu8_UartLine);
    }
}
