 ...
 * @{
 */
#define GAP_ADDR_TYPE_PUBLIC                        0x00    //addr is set by user,value is fixed forever
#define GAP_ADDR_TYPE_PRIVATE                       0x01    //addr is set by user,value is fixed after device is power on
#define GAP_ADDR_TYPE_RANDOM_RESOVABLE              0x02    //addr is generated by stack with IRK
#define GAP_ADDR_TYPE_RANDOM_NONE_RESOVABLE         0x03    //addr is generated by stack,value is randomly
...
/** @defgroup GAP_TK_TYPE_DEFINES
 * @{
 */
#define GAP_TK_TYPE_OOB      0X00
#define GAP_TK_TYPE_DISPLAY  0X01
#define GAP_TK_TYPE_ENTRY    0X02
/** @} End GAP_TK_TYPE_DEFINES */
...
typedef enum
{
    ...
    GAP_EVT_SET_WL,                //!< Add device to white list 
    GAP_EVT_DELETE_WL,             //!< Delete the device in the white lis 
} gap_event_type_t;
 ...
 * GLOBAL VARIABLES
 */
// potiner to string of gap module log tag, will be ouput before log  
extern const char *gap_tag;
// global variable to set gap module log level, see @defgroup LOG_LEVEL_DEFINES 
// default value is: LOG_LEVEL_INFO
extern uint8_t gap_local_log_level;

// potiner to string of security management module log tag, will be ouput before log 
extern const char *sm_tag;
// global variable to set security management module log level, see @defgroup LOG_LEVEL_DEFINES
// default value is: LOG_LEVEL_INFO
extern uint8_t sm_local_log_level;

// potiner to string of bond management log tag, will be ouput before log 
extern const char *bond_m_tag;
// global variable to set bond management module log level, see @defgroup LOG_LEVEL_DEFINES
// default value is: LOG_LEVEL_INFO
extern uint8_t bond_m_local_log_level;
/*
 * LOCAL VARIABLES
 */
 ...
 * @return  None.
 */
void gap_address_get(mac_addr_t *addr, enum ble_addr_type *addr_type);
 ...
 * @return  None.
 */
void gap_address_set(mac_addr_t *addr, enum ble_addr_type addr_type);
/*********************************************************************
 * @fn      gap_address_set_running
 *
 * @brief   Configure BLE mac address when device is running.
 ...
 * @return  None.
 */
void gap_address_set_running(mac_addr_t *addr, enum ble_addr_type addr_type);
/*********************************************************************
 * @fn      gap_set_mtu
 *
 ...
 * @return  None.
 */
void gap_rmv_wl(gap_mac_addr_t *p_addr_rmv,uint8_t size);
/*********************************************************************
 * @fn      gap_set_ral
 *
 ...
 * @return  none.
 */
void gap_dev_name_set(uint8_t *p_name,uint8_t len);
 ...
 */
uint8_t gap_dev_name_get(uint8_t* p_name);
