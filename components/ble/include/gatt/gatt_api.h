...
// potiner to string of gatt module log tag, will be ouput before log  
extern const char *gatt_tag;
// global variable to set gatt module log level, see @defgroup LOG_LEVEL_DEFINES
// default value is: LOG_LEVEL_WARNING
extern uint8_t gatt_local_log_level;
